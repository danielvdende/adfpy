...
from better_adf.activities.control import AdfSetVariableActivity, AdfIfConditionActivity
from better_adf.activities.execution import AdfCopyActivity, AdfLookupActivity, AdfSqlServerStoredProcedureActivity
...
previous_watermark = AdfLookupActivity(name="previousWatermark",
                                       dataset="landing",
                                       source=BlobSource,
                                       pipeline=watermark_pipeline)

current_watermark = AdfLookupActivity(name="currentWatermark",
                                      dataset="staging",
                                      source=BlobSource,
                                      pipeline=watermark_pipeline)
...
watermark_update_condition = AdfIfConditionActivity(
   ...
   if_false_activities=[],
   if_true_activities=[AdfSqlServerStoredProcedureActivity(
       name="watermark_name",
